...
public class Account {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (isValidID(id, accounts)) {
				...
				do {	
					// Get user choice
					choice = displayMainMenu(ob);
					if (isTransaction(choice)) {
							executeTransaction(choice, accounts, id, ob);
					}
	...
	/** Display main menu */
	public static int displayMainMenu(Scanner ob) {
		System.out.print(
			"\nMain menu\n1: check balance\n2: withdraw" + "\n3: deposit\n4: exit\nEnter a choice: ");
		return ob.nextInt();
	}
	...
	public static void executeTransaction(int c, Account[] a, int id, Scanner ob) {
		switch (c) {
			...
			case 2: // Withdraw money
					  ...
					  a[id].withdraw(ob.nextDouble());
					  break;
			case 3: // Deposit money
					  System.out.print("Enter an amount to deposit: "); 
					  a[id].deposit(ob.nextDouble());
		}
	}
}